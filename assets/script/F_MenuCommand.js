...
function F_MenuCommandProc() {};

F_MenuCommandProc.AddNumber = function(_Num, _AddNum) {
    if (_Num == 0) {
        _Num = _AddNum;
        return _Num;
    }
...
F_MenuCommandProc.MenuCommandProc = function(_Info) {
...
module.exports = F_MenuCommandProc;